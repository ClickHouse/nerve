"""V50: which databases start with setup complete."""
...
_V050 = importlib.import_module("nerve.db.migrations.v050_instance_setup")


async def _schema_before_v050(db: aiosqlite.Connection) -> None:
