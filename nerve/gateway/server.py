...
class WebSocketConnection:
    ...
    attributed to, and a later disable, rename or second account leaves it
    exactly as it was. The next connection re-resolves from scratch, which is
    where such a change takes effect.
